                    ...
                    <div className="col-span-3 sm:col-span-2">
                      ...
                      <div className="mt-1 flex rounded-md shadow-sm">
                        <input
                          ...
                          name="title"
                          id="Title"
                          className="focus:ring-indigo-500 focus:border-indigo-500 border flex-1 block w-full rounded-none rounded-r-md sm:text-sm border-gray-300 px-2 py-1 text-sm"
